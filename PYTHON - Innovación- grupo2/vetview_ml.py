...
# ==========================================
# 16. GUARDAR MODELO Y PREPROCESADOR PARA STREAMLIT
# ==========================================
print("\n" + "="*80)
print("💾 GUARDANDO MODELO PARA STREAMLIT")
print("="*80)
...
joblib.dump(pipeline_ganador, 'modelos/vetview_modelo_completo.pkl')
print("✅ Modelo guardado: modelos/vetview_modelo_completo.pkl")

# Guardar información del modelo
info_modelo = {
    'nombre': mejor_modelo['modelo'],
    'f1_score': float(mejor_modelo['f1']),
    'recall': float(mejor_modelo['recall']),
    'precision': float(mejor_modelo['precision']),
    'accuracy': float(mejor_modelo['accuracy']),
    'auc_roc': float(mejor_modelo.get('auc_roc', 0)),
    'columnas': X.columns.tolist()
}
joblib.dump(info_modelo, 'modelos/info_modelo.pkl')
print("✅ Info del modelo guardada: modelos/info_modelo.pkl")

# También guardar una copia en la raíz por si acaso
joblib.dump(pipeline_ganador, 'vetview_modelo_completo.pkl')
joblib.dump(info_modelo, 'info_modelo.pkl')
print("✅ Copias de seguridad guardadas en la raíz")

print("\n✅ ¡Listo! Ahora ejecuta: streamlit run app.py")
print("="*80)
# ==========================================
# 16. GUARDAR MODELO Y PREPROCESADOR PARA STREAMLIT
# ==========================================
