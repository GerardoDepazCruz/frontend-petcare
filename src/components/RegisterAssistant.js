...
function RegisterAssistant() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://veterinaria-petcare.onrender.com/d/w/api/auth/register", {
        method: "POST",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Enlace de login */}
        <Typography variant="body2" sx={{ mt: 3, color: "#091F5B" }}>
          ¿Ya tienes cuenta?{" "}
          <Link to="/asistente" style={{ fontWeight: "bold", color: "#344EAD" }}>
            Inicia sesión aquí
          </Link>
        </Typography>
      </Paper>
