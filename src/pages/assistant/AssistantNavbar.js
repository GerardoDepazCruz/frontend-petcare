...
export default function AssistantNavbar() {
  ...
  const menuItems = [
    { label: "Inicio", value: "/asistente/home", icon: <HomeIcon /> },
    { label: "Mascotas", value: "/asistente/mascotas", icon: <PetsIcon /> },
    { label: "Veterinarios", value: "/asistente/veterinarios", icon: <MedicalServicesIcon /> },
    { label: "Citas", value: "/asistente/citas", icon: <EventAvailableIcon /> },
  ];
