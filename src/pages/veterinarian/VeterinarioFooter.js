      ...
      >
        ...
        <Box sx={{ textAlign: "center" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", gap: 2, mt: 1 }}>
            <MuiLink href="https://www.facebook.com/Petcareoficial/?locale=es_LA" target="_blank" rel="noopener noreferrer">
              <img src="/facebook.png" alt="Facebook" height="40" />
            </MuiLink>
            <MuiLink href="https://www.instagram.com/petcareperu/" target="_blank" rel="noopener noreferrer">
        ...
        >
          <Typography variant="h6" sx={{ fontWeight: "bold", color: "#344EAD", mb: 0.5 }}>
            Contacto
          </Typography>
        ...
        <Box sx={{ textAlign: "center", minWidth: 200 }}>
          <img src="/libro-reclamaciones.jpg" alt="Libro de Reclamaciones" height="80" />
          <Typography variant="h6" sx={{ mt: 1, fontWeight: "bold", color: "#1E1E1E", mb: 0.5 }}>
            Libro de Reclamaciones
          </Typography>
        </Box>
      </Box>
...
export default FooterVeterinario;
