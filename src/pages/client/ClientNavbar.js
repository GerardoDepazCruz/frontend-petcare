...
export default function Navbar() {
  ...
  const menuItems = [
    { label: "Inicio", value: "/cliente/home", icon: <HomeIcon /> },
    { label: "Nosotros", value: "/cliente/nosotros", icon: <InfoIcon /> },
    { label: "Contacto", value: "/cliente/contacto", icon: <ContactMailIcon /> },
    { label: "Mascota", value: "/cliente/mascota", icon: <PetsIcon /> },
    { label: "Servicios", value: "/cliente/servicios", icon: <MiscellaneousServicesIcon /> },
    { label: "Agendar Cita", value: "/cliente/agendarcita", icon: <EventAvailableIcon /> },
  ];
